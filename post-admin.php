...
$req="select * from admin where idadmin=".$id_user."";
...
<h1>Ajouter un mot de passe à un administrateur </h1>
<form action="post-admin-exe.php" method="post">
<div class="form-group">
    <label for="InputName">ID</label><input type="hidden" name="id" value="<?php echo $ligne["idadmin"];?>">
</div>
<div class="form-group">	
